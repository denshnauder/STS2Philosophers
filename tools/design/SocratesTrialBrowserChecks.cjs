...
(async()=>{
  ...
  try{
    ...
    assert.deepEqual(errors,[]);console.log('PASS browser: ordinary/skip baselines, trial loop, neutral handling, seven follow-up states, continuous counterexamples, preserved old material, no inherited beliefs, safe text and responsive themes.');
